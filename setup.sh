...
bash "$parent_path/scripts/make_client_key.sh" 1
bash "$parent_path/scripts/make_client_key.sh" 2
...
cert_to_revoke="$client_cert_dir/client2-key.cert.pem"

bash "$parent_path/scripts/revoke_certificate.sh" $cert_to_revoke
